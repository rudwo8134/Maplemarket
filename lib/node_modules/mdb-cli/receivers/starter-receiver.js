...
var StarterReceiver = /** @class */ (function (_super) {
    ...
    StarterReceiver.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var queryParamType, queryParamAvailable, response, starters, available, unavailable, i, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this._printStartersMap(output_color_1.OutputColor.Green, 'Available starters:', this._buildStartersMap(available));
                        if (this.flags.all) {
                            this._printStartersMap(output_color_1.OutputColor.Red, 'Unavailable starters:', this._buildStartersMap(unavailable));
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        return [2 /*return*/, this.result.addAlert(output_color_1.OutputColor.Red, 'Error', "Could not fetch starters: " + e_1.message)];
