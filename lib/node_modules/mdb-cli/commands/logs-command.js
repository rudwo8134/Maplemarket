...
var LogsCommand = /** @class */ (function (_super) {
    __extends(LogsCommand, _super);
    function LogsCommand(context) {
    ...
    LogsCommand.prototype.execute = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.receiver.logs()];
                    case 1:
                        _a.sent();
    ...
    LogsCommand.prototype.setReceiver = function (ctx) {
        switch (this.entity) {
    ...
    LogsCommand.prototype.help = function () {
