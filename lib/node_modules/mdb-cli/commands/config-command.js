...
var config_receiver_1 = __importDefault(require("../receivers/config-receiver"));
...
var ConfigCommand = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.receiver.changeConfig()];
                    case 1:
                        _a.sent();
    ...
    ConfigCommand.prototype.setReceiver = function (ctx) {
        switch (this.entity) {
            case entity_1.default.Config:
                this.receiver = new config_receiver_1.default(ctx);
                break;
    ...
    ConfigCommand.prototype.help = function () {
