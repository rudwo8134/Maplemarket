...
var receiver_1 = __importDefault(require("../receivers/receiver"));
...
var InfoCommand = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.receiver.info()];
                    case 2:
                        _a.sent();
                        this.printResult([this.receiver.result]);
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, this.detectReceiver()];
                    case 4:
                        _a.sent();
                        if (!this.receiver)
                            return [2 /*return*/, this.help()];
    ...
    InfoCommand.prototype.detectReceiver = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, receiver_1.default.detectEntity(this.context)];
                    case 1:
                        _a.entity = _b.sent();
                        return [4 /*yield*/, this.setReceiver()];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
