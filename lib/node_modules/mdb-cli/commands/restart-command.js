...
var RestartCommand = /** @class */ (function (_super) {
    ...
    RestartCommand.prototype.execute = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.receiver.restart()];
                    case 1:
                        _a.sent();
    ...
    RestartCommand.prototype.setReceiver = function (ctx) {
        switch (this.entity) {
    ...
    RestartCommand.prototype.help = function () {
