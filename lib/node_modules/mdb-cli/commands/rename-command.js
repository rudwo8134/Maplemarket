...
var RenameCommand = /** @class */ (function (_super) {
    __extends(RenameCommand, _super);
    function RenameCommand(context) {
        var _this = _super.call(this, context) || this;
        _this.setReceiver(context);
        return _this;
    }
    RenameCommand.prototype.execute = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.receiver.rename()];
                    case 1:
                        _a.sent();
    ...
    RenameCommand.prototype.setReceiver = function (ctx) {
        var _this = this;
        if (!this.entity) {
